...
public class Question1 {
    public static void main(String[] args) {
        ...
        // Initialisation du tableau des noms et des prix
        ...
        for (int i = 0; i < taillePanier; i++) {
            ...
            afficherDescriptifAccessoire(nom, prixHT);  // Utiliser la nouvelle procédure
    ...
    // Nouvelle procédure pour afficher un texte descriptif de chaque accessoire
    private static void afficherDescriptifAccessoire(String nom, double prixHT) {
